...
setwd("~/OneDrive - The Mount Sinai Hospital/Data/Collaborations/RamageLab/20240130-WNV-reanalysis/20240130-WNV-ph/go_hypergeo/")
...
subquant <- read.delim(file = "../msstats/20240130-WNV-ph-subquant.txt", quote = "", stringsAsFactors = FALSE)
